...
import { FaThreads, FaGithub, FaFacebook, FaXTwitter, FaYoutube, FaInstagram, FaLinkedinIn } from 'react-icons/fa6'
import Aos from 'aos'
  ...
  return (
      <div className='fixed h-screen  right-1 sm:right-3 xl:right-11 z-[1] '>
        <div className='flex flex-col text-xl sm:text-2xl gap-y-5 sm:gap-y-5 absolute right-0 inset-y-0 justify-center ' data-aos='fade-in' data-aos-once='true'>
            ...
            <a className=' cursor-pointer' href='https://twitter.com/dylexbenji' target='_blank' data-aos='fade-left' data-aos-delay='400' data-aos-once='true'><FaXTwitter/></a>
            ...
            <a className=' cursor-pointer' href='https://www.linkedin.com/in/benjamin-chukwudile-56164b1b3/' target='_blank' data-aos='fade-left' data-aos-delay='500' data-aos-once='true'><FaLinkedinIn /></a>
