...
// Insert the return component calling `getContent()` below
  return (
    <div>
      <div className={styles.container}><div className='fixed top-16 sm:top-24 z-[2] font-zenDots border-l-2 border-gray-400 pl-5 text-white font-bold [text-shadow:_-1px_-1px_0_rgb(7_9_4),_-1px_1px_0_rgb(7_9_9),_-1px_1px_0_rgb(7_9_9),_1px_1px_0_rgb(7_9_9)]'>SOFTWARE PROJECTS</div></div>       

      <div className='relative h-[100px] sm:h-[150px] w-full bg-fixed overflow-hidden' style={{ backgroundImage: 'url(/software.webp)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', margin: 0 }}>
